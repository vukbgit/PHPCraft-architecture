...
* __application-root__: the folder where the application resides, the folder of __your-domain.tld__ webspace where (at least) the folders _private_, _public_ and _vendor_  are created into
* __vertical-hierarchy__: the levels application is divided into, top-down: application, area, subject, action, providing a conceptual inheritance flow
